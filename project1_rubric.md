...
- [ /10] Deployment steps/tutorial documented in Marp slide (and converted into PDFs)
  ...
  - [T/F] A screen capture of your NGINX server working should be included (any screen capture is OK when it shows NGINX is working) — add `presentation/images/nginx-status.png`
